class Covid19::Country
    ...
    attr_accessor :name, :code, :population, :updated_at, :today_deaths, :today_confirmed, :latest_deaths, :latest_confirmed, :recovered, :critical,  :death_rate, :recovery_rate, :recovered_vs_death_ratio, :cases_per_million_population 
